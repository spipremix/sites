...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'avis_site_syndique_probleme' => 'Увага: не вдалося імпортувати матеріали. Внаслідок цього роботу модуля імпорту було припинено. Перевірте посилання на файл-джерело (<b> @url_syndic@ </b>) і спопробуйте ще раз.',
	...
	'item_bloquer_liens_syndiques' => 'Усі сайти вимагають перевірки перед доданням',
	'item_gerer_annuaire_site_web' => 'Включити каталог сайтів та імпорт статтей по RSS',
	'item_non_bloquer_liens_syndiques' => 'За замовчуванням дозволити додавати матеріали',
